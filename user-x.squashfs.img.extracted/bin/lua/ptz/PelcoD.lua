...
Protocol.PositionAbsProcess = function(s,arg1, arg2, arg3, T)
	...
	if s[1] == 0xFF then
		...
		s[7] = math.mod((s[2] + s[3] + s[4] + s[5] + s[6]), 256);
		s[12] = bits.band(bits.bor((bits.band(arg2,0xffff)),(bits.band(arg2,0x80000000)/(256*256))), 0xff00)/256;
		s[13] = bits.band(bits.bor((bits.band(arg2,0xffff)),(bits.band(arg2,0x80000000)/(256*256))), 0xff);
